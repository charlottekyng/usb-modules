...
RUN_FACETS = usb-modules/copy_number/runFacets.R
FACETS_PRE_CVAL ?= 50
FACETS_CVAL1 ?= 150
FACETS_CVAL2 ?= 50
FACETS_MIN_NHET ?= 25
...
GET_BASE_COUNTS = usb-modules/copy_number/facets-snp-pileup.pl
...
facets/snp_pileup/$1_$2.bc.gz : bam/$1.bam bam/$2.bam
	$$(call LSCRIPT_CHECK_MEM,3G,00:59:59,"$$(GET_BASE_COUNTS) bam/$2.bam bam/$1.bam $$@ $$(GET_BASE_COUNTS_PARAMS)")
endef
...
facets/cncf/%.cncf.txt : facets/snp_pileup/%.bc.gz
	$(call LSCRIPT_CHECK_MEM,3G,00:29:59,"$(RUN_FACETS) $(FACETS_OPTS) --outPrefix $(@D)/$* $<")
