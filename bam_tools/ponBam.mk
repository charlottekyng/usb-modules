...
unprocessed_bam/pon.rg.bam : $(foreach normal,$(NORMAL_SAMPLES),bam/$(normal).downsampled.bam) $(addsuffix .bai,$(foreach normal,$(NORMAL_SAMPLES),bam/$(normal).downsampled.bam))
